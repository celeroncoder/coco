...
const GLSLHills = ({ width = '100vw', height = '100vh', cameraZ = 125, planeSize = 256, speed = 0.5 }) => {
  ...
  useEffect(() => {
    ...
    // Create a container to handle sizing more predictably
  ...
  return (
    <div ref={containerRef} style={{ position: 'relative', width, height, overflow: 'hidden' }} className="pointer-events-none opacity-50 dark:opacity-30"> 
      <canvas
        ref={canvasRef}
        style={{
          position: 'absolute',
